...
driver.find_element(by=AppiumBy.XPATH, value="//android.widget.EditText[@text='Password']").send_keys("WpUAS1234#")
time.sleep(2)
...
driver.find_element(by=AppiumBy.XPATH, value="//android.widget.CheckBox["
                                             "@resource-id='wp.wattpad:id/disclaimer_checkbox']").click()
