...
driver.find_element(by=AppiumBy.XPATH, value="//android.widget.ImageButton[@resource-id='wp.wattpad:id/add_button']").click()

driver.find_element(by=AppiumBy.XPATH, value="//android.widget.TextView[@resource-id='wp.wattpad:id/list_name' and "
                                             "@text='Library (Private)']").click()
